...
const perform = async (z, bundle) => {
  const response = await z.request({
    url: `https://app.portal.vivomeetings.com/enterprise_api/host/fetch`,
    method: 'POST',
  });
  // this should return an array of objects

  let field =[]
  field.push(response.json)
...
module.exports = {
  ...
  display: {
    ...
    description: "Triggers when there's a Host is created.",
    important:false,
    hidden: true
  },
  ...
  operation: {
    ...
    sample: {
      "host_id": 4085768,
      "name": "ankit porwal",
      "email": "ankit@vkaps.com",
      "meeting_url": "https://vkaps.portal.vivomeetings.com/conf/call/9697638",
      "role": "COMPANY_ADMIN",
      "access_code": 9697638
  },
