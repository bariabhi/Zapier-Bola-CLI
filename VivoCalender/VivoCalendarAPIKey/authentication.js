...
const test = (z, bundle) =>
  z.request({ url: 'http://app.vivocalendar.com/api/v3/me',
...
const handleBadResponses = (response, z, bundle) => {
  z.console.log("response3", bundle.authData.api_key);
...
module.exports = {
  config: {
    ...
    fields: [{ key: 'api_key', label: 'API Key1', helpText: 'Go to the [API Details](https://app.vivocalendar.com/integrations#api) screen from your Website API section to find your API Key',required: true }],
